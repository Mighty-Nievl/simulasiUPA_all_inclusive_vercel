        ...
        <div className="text-center max-w-md">
          {error ? (
            ...
            <>
              ...
              <p className="text-base text-slate-400 font-medium">Memuat soal...</p>
            </>
          )}
        </div>
      </div>
        ...
        <div className="flex-1 flex items-center justify-center p-4 md:p-8 overflow-y-auto">
          <div className="w-full max-w-4xl">
            <div className="text-center mb-10">
              <div className="mb-6 flex justify-center">
                {results.success ? (
                  <div className="bg-emerald-900/50 p-6 rounded-full shadow-2xl shadow-emerald-900/20 animate-scaleIn">
                    <svg className="w-20 h-20 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                ) : (
                  <div className="bg-amber-900/50 p-6 rounded-full shadow-2xl shadow-amber-900/20 animate-scaleIn">
            ...
            {!results.success && (
              <div className="space-y-6 mb-10">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="text-xl font-bold text-white">Pembahasan Jawaban Salah</h3>
                </div>
                ...
                {questions.map((q, index) => {
                  ...
                  return (
                    <div key={q.id} className="bg-slate-800/60 border border-slate-700 rounded-2xl p-6 shadow-lg hover:border-slate-600 transition-colors">
                      <div className="flex items-start gap-4 mb-4">
                        <div className="flex-shrink-0 w-8 h-8 bg-slate-700 rounded-full flex items-center justify-center text-sm font-bold text-slate-300">
                          {index + 1}
                        </div>
                        <div className="flex-1">
                          <p className="text-white font-medium text-lg mb-4">{q.question}</p>
                          
                          <div className="grid md:grid-cols-2 gap-4 mb-4">
                            <div className="bg-red-900/20 border border-red-900/50 rounded-xl p-4">
                              <p className="text-xs text-red-400 font-bold uppercase tracking-wider mb-1">Jawaban Anda</p>
                              <p className="text-red-200">{q.options[userAnswerIndex] || 'Tidak dijawab'}</p>
                            </div>
                            <div className="bg-emerald-900/20 border border-emerald-900/50 rounded-xl p-4">
                              <p className="text-xs text-emerald-400 font-bold uppercase tracking-wider mb-1">Jawaban Benar</p>
                              <p className="text-emerald-200">{q.options[q.correctAnswer]}</p>
                            </div>
                          </div>
                          ...
                          <div className="bg-slate-900/50 rounded-xl p-5 border border-slate-700/50">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className="text-sm font-bold text-amber-400 uppercase tracking-wider">Penjelasan</span>
                            </div>
                            <p className="text-slate-300 text-sm leading-relaxed">
                              {q.explanation || "Maaf, tidak ada penjelasan untuk soal ini."}
                            </p>
                          </div>
                        </div>
                      </div>
      ...
      `}>
        ...
        <div className="p-4 border-b border-slate-700">
          <div className="flex items-center gap-2.5 mb-2">
            ...
            <div>
              <h2 className="text-sm font-bold text-white">Simulasi UPA PERADI</h2>
            </div>
          </div>
          <p className="text-xs text-slate-400">Ujian Profesi Advokat - Sistem Pembelajaran Gamifikasi</p>
        </div>
        ...
        <div className="p-3 flex-1">
          <div className="mb-3">
            <div className="text-xs text-slate-400 mb-2 font-medium">Progress Sesi</div>
            <div className="text-sm font-bold text-white mb-2">Sesi {sessionId} dari 20</div>
            {/* Progress Bar */}
            ...
            <div className="text-xs text-slate-400 mt-1">{Math.round((sessionId / 20) * 100)}% selesai</div>
          </div>
      ...
      <div className="flex-1 flex flex-col w-full md:w-auto">
        ...
        <div className="bg-slate-800/80 backdrop-blur-md border-b border-slate-700 px-4 md:px-6 py-3">
          ...
          <div className="flex justify-between items-center gap-4">
            <div className="flex-1 min-w-0">
              <h2 className="text-sm md:text-base font-bold text-white truncate">Sesi {sessionId} - 10 Soal</h2>
        ...
        <div className="flex-1 bg-slate-900 p-4 md:p-6 overflow-y-auto">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Question Text */}
            <p className="text-sm md:text-base text-white mb-4 md:mb-6 leading-relaxed font-medium">{currentQuestion.question}</p>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0 transition-all ${
                        isSelected ? 'border-white bg-white scale-110' : 'border-slate-500'
                      }`}>
