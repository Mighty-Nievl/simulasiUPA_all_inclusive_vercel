...
export const SITE_CONFIG = {
  // Domain config
  rootDomain,
  appUrl: (process.env.NEXT_PUBLIC_APP_URL?.startsWith("http") ? process.env.NEXT_PUBLIC_APP_URL : `${protocol}://${process.env.NEXT_PUBLIC_APP_URL}`) || `${protocol}://${rootDomain}/dashboard`,
