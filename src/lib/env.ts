...
function validateEnv() {
  ...
  return {
    ...
    NEXT_PUBLIC_LOGIN_URL: formatUrl(process.env.NEXT_PUBLIC_LOGIN_URL || `https://${domain}/login`),
    NEXT_PUBLIC_REGISTER_URL: formatUrl(process.env.NEXT_PUBLIC_REGISTER_URL || `https://${domain}/daftar`),
